...
Один из первых и точно самый популярный клеточный автомат в 1970 придумал ${a('https://en.wikipedia.org/wiki/John_Horton_Conway')('Джон Конвей')} и назвал его ${a('https://en.wikipedia.org/wiki/Conway%27s_Game_of_Life')('Игра Жизнь')}.
...
Также сегодня есть достаточно быстрая программа ${a('https://en.wikipedia.org/wiki/Golly_(program)')('Golly')}, которая оптимизирует расчёты.


${a('/?/projects/game-of-life')('Реализация')} лежит в разделе ${a('/?/projects')('Проекты')}. Вообще в раздел Проекты будут попадать все новые вещи, пока я не решу выделить им отдельное пространство имён.
...
Для каждого из состояний следующее состояние определяется суммой живых клеток в ${a('https://en.wikipedia.org/wiki/Moore_neighborhood')('окрестности Мура')}.
...
С ${a('https://www.conwaylife.com/wiki/Main_Page')('тематического сайта')} я отобрал наиболее интересные мне экземпляры.
По умолчанию выбрана самая сложная конфигурация из представленных.
Все конфигурации записаны в коде ${a('https://www.conwaylife.com/wiki/Run_Length_Encoded')('RLE')}, его также можно посмотреть, нажав галочку код конфигурации.
...
Я хотел убедится, что ${a('/?/blog/3')('движок')}(ещё сырой) справится с нагрузкой.
...
Также были использованы новые иконки из бесплатного ${a('https://fontawesome.com/icons?d=gallery&m=free')('набора')} Font Awesome.


Для интересующихся всегда есть ${a('https://github.com/nikalexxx/nikalexxx.github.io/blob/master/components/GameOfLife/GameOfLife.js')('исходники')}.
`;
