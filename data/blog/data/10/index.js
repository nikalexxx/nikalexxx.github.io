...
Пока для ${a('https://wikipedia.org')('википедии')} и ${a('https://github.com')('гитхаба')}.
...
${h(3)`Новые разделы`}
Давно уже есть темы, но решил завести для них ${a('?/design/themes')('отдельную страничку')} в разделе ${a('?/design')('дизайна')}.
Сравниваются тёмная и светлая темы для одинакового контента.


Создан раздел ${a('?/catalog')('Каталог')}.
