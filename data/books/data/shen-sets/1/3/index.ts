...
export default (api) => {
    ...
    return _`
${paragraph('1.3. Равномощные множества')}
...
${problem(api)} Докажите, что любые два интервала ${$`(a, b)`} и ${$`(c, d)`} на прямой равномощны.


${problem(api)} Докажите, что любые две окружности на плоскости равномощны.
Докажите, что любые два круга на плоскости равномощны.


${problem(api)} Докажите, что полуинтервал ${$`[0, 1)`} равномощен полуинтервалу ${$`(0, 1]`}.
...
Этот ход мыслей правилен, как показывает ${draft`теорема Кантора – Бернштейна из раздела 6`}.
