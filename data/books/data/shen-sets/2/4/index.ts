...
Тогда все меньшие элементы принадлежат ${$`I`}, сам ${$`x`} не принадлежит ${$`I`} и все бо´льшие ${$`x`} элементы не принадлежат ${$`I`}, иначе получилось бы противоречие с определением начального отрезка.)
`}
`)}
${li(_`
