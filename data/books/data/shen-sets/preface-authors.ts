...
Для более подробного знакомства с теорией множеств читатель может обратиться к другим книгам (некоторые из них перечислены в ${draft`списке литературы на с. 105`}).
...
${enote(api)} ${i`Для электронной версии неприменимо`}
