...
Для более подробного знакомства с теорией множеств читатель может обратиться к другим книгам (некоторые из них перечислены в ${link.ref('lib')`списке литературы`} ${printNote`с. 105`}).
