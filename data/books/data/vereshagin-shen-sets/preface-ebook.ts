...
export default (api: BookApi) => {
    const { book, link, em } = api;
    const {chapter} = getCustomElements(api);
    return book`
${chapter.noIndex(true)`Предисловие к электронному изданию`}
Издание от 10.02.2021. Основано на ${link.href('https://www.mccme.ru/shen/logic/sets/part1-6ed.pdf')`шестом издании`} печатной версии 2020 года.
