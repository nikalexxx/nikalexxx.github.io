    ...
    return () =>
        E.div(
            ...
            E.div.style`padding: 15px;`(
                ...
                Со стороны правого берега реки — горы с ещё снежными вершинами, по левому берегу — Тавдинские пещеры и Долина гротов, залитые солнцем. Много вечнозелёных сосен, но уже начали распускаться первые цветы и набухать почки на деревьях. Скоро зацветёт маральник, местный цветок, в честь которого даже есть праздник. Вид гор, покрытых ковром цветов, должен быть впечатляющим. Значит не прощаемся, Алтай.
                `),
                E.br,
                E.p
                ...
                E.br,
                Gallery.imgList(imgList).imgPath('./data/images/travels/altai')
            )
        );
});
